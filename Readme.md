...
git checkout "<branch name>" - switch to a different Git local branch 
...
git submodule add <Git submodule repository URL> - reference external shared GitHub repositories
